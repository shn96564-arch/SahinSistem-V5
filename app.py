...
# --- 🦅 ŞAHİN SİSTEM v6.5 (OKUL ÖZEL) ---
st.set_page_config(page_title="Şahin Sistem v6.5", layout="wide")
...
st.markdown('<div class="header-box"><h1 style="color: white; margin:0;">🦅 ŞAHİN SİSTEM v6.5</h1><p style="color: #00ff41; font-weight: bold;">[ DURUM: AKTİF ]</p><p style="color: #d4af37; font-size: 14px;">YUSUF EFE ŞAHİN | 7/D</p></div>', unsafe_allow_html=True)
...
try:
    ...
    # EN GARANTİ MODEL İSMİ (HATA ALMAMAK İÇİN)
    model = genai.GenerativeModel('gemini-1.5-flash')
    
    talimat = "Sen Şahin Sistem'sin. Yusuf Efe Şahin seni kodladı. 7. sınıf derslerinde bir dahisin."
